...
\usepackage{url}
\usepackage{booktabs}
\title{Tactile Pretraining Negative Transfer: ICLR Main-Conference Gate Archive}
\author{Anonymous Authors}
\begin{document}
\maketitle
\begin{abstract}
This document is not an ICLR main-conference submission. It is the v3 main-conference gate for a generated robotics draft about tactile representation learning. The original research bet was: Identify tactile pretraining signals that harm downstream contact control. After a stricter hostile review, the honest terminal decision is \textbf{KILL/ARCHIVE}. Submission-hardening version: v3.
\end{abstract}
...
\begin{itemize}
\item Sim2Real Transfer of Imitation Learning of Motion Control for Car-like Mobile Robots Using Digital Twin Testbed (2025)
\item High-Bandwidth Tactile-Reactive Control for Grasp Adjustment (2025)
\item PolyTouch: A Robust Multi-Modal Tactile Sensor for Contact-rich Manipulation Using Tactile-Diffusion Policies (2025)
\item Magnetic-based Soft Tactile Sensors with Deformable Continuous Force Transfer Medium for Resolving Contact Locations in Robotic Grasping and Manipulation (2019)
\item TranTac: Leveraging Transient Tactile Signals for Contact-Rich Robotic Manipulation (2025)
\end{itemize}
