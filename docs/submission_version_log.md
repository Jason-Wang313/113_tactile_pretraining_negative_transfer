...
Rebuilt as a tactile negative-transfer empirical package. Added paper-specific benchmark, strong baselines, paired-seed tests, stress sweep, ablations, figures, tables, revised docs, and an evidence manuscript.
